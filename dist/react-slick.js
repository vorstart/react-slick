...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getTrackCSS = exports.getTrackCSS = function getTrackCSS(spec) {
	  ...
	  var style = {
	    opacity: 1,
	    WebkitTransform: !spec.vertical ? 'translate(' + spec.left + 'px, 0px)' : 'translate(0px, ' + spec.left + 'px)',
	    transform: !spec.vertical ? 'translate(' + spec.left + 'px, 0px)' : 'translate(0px, ' + spec.left + 'px)',
	    transition: '',
	    WebkitTransition: '',
